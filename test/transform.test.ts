 ...
 *
 * Exercises class-attribute rewriting with a mock alphabetical sorter: quote styles and multiline normalisation,
 * island handling (segments sorted independently, glued fragments pinned, no whitespace invented), untouched zones
 * (PHP echo strings, `script`/`style` content, HTML comments), custom attribute lists and idempotency.
 */
...
test('multiline value is normalised to single spaces', () => {
