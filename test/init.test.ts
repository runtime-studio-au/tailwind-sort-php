 ...
 * exit codes, and refusal messages it produces. Global and system git config is masked, so a user-level hooks-path
 * setting can't change behavior. Skips when git isn't available.
 */
