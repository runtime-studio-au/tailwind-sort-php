 ...
 *
 * Verifies island boundary detection across short tags and the XML-declaration exclusion, closing sequences inside
 * strings, heredocs/nowdocs and comments (block vs. line), PHP 8 attributes, case-insensitive open tags, multiple
 * islands, and files that end in PHP mode.
 */
